...
2. Read roadmap: `docs/roadmaps/MASTER_ROADMAP.md` - find QA-044
3. Check for conflicts: `docs/ACTIVE_SESSIONS.md`
4. Create session file: `docs/sessions/active/Session-$(date +%Y%m%d)-QA-044-$(uuidgen | cut -d'-' -f1).md`
5. Register session atomically in `docs/ACTIVE_SESSIONS.md`

### Phase 2: Implementation

1. Create feature branch: `git checkout -b qa-044-fix`
...
4. **Push directly to main:** `git push origin qa-044-fix:main`
