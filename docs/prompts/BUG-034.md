...
### Router Files (containing BUG-033 hotfixes to remove):

| File | Procedures | Hotfix Count |
|------|------------|--------------|
| `server/routers/accounting.ts` | ledger.list, invoices.list, bills.list, payments.list, bankAccounts.list, bankTransactions.list, expenseCategories.list, expenses.list | 8 |
| `server/routers/clients.ts` | list | 1 |
| `server/routers/inbox.ts` | getUnread, getByStatus | 2 |
| `server/routers/inventory.ts` | getBatchesByVendor, vendors, brands, views.list, profitability.top, dashboardStats | 6 |
| `server/routers/orders.ts` | getAll | 1 |
| `server/routers/purchaseOrders.ts` | getAll | 1 |
| `server/routers/samples.ts` | getPending | 1 |
| `server/routers/strains.ts` | list, search, fuzzySearch | 3 |
| `server/routers/todoLists.ts` | getMyLists, getMembers | 2 |
| `server/routers/todoTasks.ts` | getByListId, getMyTasks, getOverdue, getDueSoon | 4 |
| `server/routers/vendors.ts` | getAll | 1 |

**Total: 11 router files, 30 procedures**
...
### ═══════════════════════════════════════════════════════════════
### PHASE 0: BASELINE ESTABLISHMENT (30 minutes)
### ═══════════════════════════════════════════════════════════════
