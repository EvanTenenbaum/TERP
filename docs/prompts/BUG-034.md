...
| inventory.ts | 0 | **5** | 5 | vendors, brands, views.list, profitability.top (NOT list - it's correct) |
...
| `server/routers/inventory.ts` | vendors (2 paths), brands (2 paths), views.list, profitability.top | 5 | Same pattern, no BUG-033 marker |
...
- [ ] **Verify inventory.ts has unmarked wrappers:** Check vendors, brands, views.list, profitability.top (5 procedures)
...
**🔒 QA GATE 3C: After vendors, purchaseOrders, orders routers**
