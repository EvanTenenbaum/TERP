...
- Use `build-source-of-truth-2026-03-19/` plus the existing detailed Orders and Inventory ledgers as the implementation-first handoff.
- Keep this file as directional design and scope guidance, not the final no-function-loss build contract.
