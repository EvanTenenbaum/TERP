...
## 🔬 SPECIAL WORKFLOW: LIVE QA

**If the user says "live qa" instead of assigning a development task:**

1. **Do NOT follow the standard development workflow above**
2. **Instead, load the QA prompt:** Read `docs/agent_prompts/live_qa/live_qa_prompt.md`
3. **Follow the 4-phase QA process** defined in that template:
   - Phase 1: Pre-Flight Check (8 mandatory steps)
   - Phase 2: Session Startup & Automation
   - Phase 3: Systematic Testing & Issue Logging (7 testing layers)
   - Phase 4: Reporting & Completion
4. **Deliver a comprehensive QA report** instead of code changes

This is a specialized workflow for quality assurance testing, not feature development. The QA process is designed to systematically test the live production site and identify all bugs, UI/UX issues, and performance problems.
