...
| Request Supplier Return | `samples.requestVendorReturn`  | mutation | strictlyProtected | (none)     |
...
## Domain 16: Purchase Orders & Intake
...
| Get Intake History         | `poReceiving.getReceivingHistory`    | query    | protected | (none)     |
| Get PO Items with Receipts | `poReceiving.getPOItemsWithReceipts` | query    | protected | (none)     |
| Get Pending Intake         | `poReceiving.getPendingReceiving`    | query    | protected | (none)     |
...
The `suppliers` router is deprecated. All supplier operations should use the `clients` router with `isSeller = true`.
...
### Protected Routes - Purchasing & Suppliers

| Route              | Page               | Primary Entity  |
| ------------------ | ------------------ | --------------- |
| `/purchase-orders` | PurchaseOrdersPage | Purchase Orders |
| `/suppliers`       | VendorsPage        | Suppliers       |
| `/suppliers/:id`   | VendorRedirect     | Supplier Detail |
| `/supplier-supply` | VendorSupplyPage   | Supplier Supply |
