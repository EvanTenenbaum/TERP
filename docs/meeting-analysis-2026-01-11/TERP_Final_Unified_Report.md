...
| **Priority**            | **Next**                                                                                                                                                                                                                      |
| **Severity**            | P2 moderate                                                                                                                                                                                                                   |
| **Meaning**             | Track batches of products by supplier to answer 'how am I doing on my flowers' questions                                                                                                                                      |
| **Acceptance Criteria** | Can view all products from a specific supplier intake with current status                                                                                                                                                     |
...
### MEET-027: Supplier vs Brand (Farmer Code) Distinction
...
| **Priority**            | **Now**                                                                                                                                                              |
| **Severity**            | P1 major                                                                                                                                                             |
| **Meaning**             | Supplier = person who drops off; Brand = farmer code (can be different)                                                                                              |
| **Acceptance Criteria** | Product has separate Supplier (who dropped off) and Brand/Farmer Code fields                                                                                         |
| **Evidence**            | `"Supplier and brand are two different things at this moment"`<br>`"T12 will bring in a buddy's flower and will list it under T23"`<br>`"So that's the brand still"` |
| **Dependencies**        | None                                                                                                                                                                 |
...
### MEET-029: Supplier Tied to Farmer Name
...
| **Priority**            | **Next**                                                      |
| **Severity**            | P2 moderate                                                   |
| **Meaning**             | Supplier field should use farmer's name for simplicity        |
| **Acceptance Criteria** | Supplier field accepts farmer names                           |
| **Evidence**            | `"I think we can just say the supplier is the farmer's name"` |
| **Dependencies**        | MEET-027                                                      |
| **UI Reference**        | Product                                                       |

### MEET-030: Supplier Search Shows Related Brands
...
| **Priority**            | **Next**                                                                                                                                                                                                                                                                           |
| **Severity**            | P2 moderate                                                                                                                                                                                                                                                                        |
| **Meaning**             | Typing supplier name shows that supplier plus all brands they've brought in                                                                                                                                                                                                        |
| **Acceptance Criteria** | Supplier search shows supplier and all associated farmer codes/brands                                                                                                                                                                                                              |
...
| **Priority**            | **Next**                                                                                                                                                                |
| **Severity**            | P2 moderate                                                                                                                                                             |
| **Meaning**             | Show what product sold for last time (same supplier)                                                                                                                    |
| **Acceptance Criteria** | Product view shows last sale price for same supplier's product                                                                                                          |
| **Evidence**            | `"Suggested what that item sold for last time is always useful"`<br>`"So I don't have to look it up because I do that all the time"`<br>`"Probably just that supplier"` |
| **Dependencies**        | None                                                                                                                                                                    |
...
| DEC-002     | Supplier will be tied to the farmer's name     | 28:04.8 - 28:09.9 | Simplifies supplier identification                                     | MEET-029       |
...
_This report was generated by Manus AI based on automated transcription and analysis of the customer meeting recording. All timestamps and quotes are approximate and should be verified against the original recording for critical decisions. All follow-up questions have been resolved with customer input._
