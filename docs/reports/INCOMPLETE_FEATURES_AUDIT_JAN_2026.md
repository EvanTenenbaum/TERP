...
| **P0-003** | `schema.ts`, `ordersDb.ts:1564-1570`            | Order status machine incomplete - missing RETURNED status with restock/supplier-return paths |
...
- Uses deprecated `suppliers.getAll` endpoint
...
- `/supplier-supply`, `/sampling`, `/analytics`, `/scheduling`
...
| `/supplier-supply` | Inventory    | Hidden |
...
| Feature                    | Task     | Status      |
| -------------------------- | -------- | ----------- |
| Batch Tracking by Supplier | MEET-023 | NOT STARTED |
...
| `/supplier-supply`        | Supplier supply management     |
...
### 4. Deprecated Supplier Router (Migration Incomplete)
...
| ------------------- | ---- | -------------------------------------------- |
| `suppliers.getAll`  | 29   | `clients.list` with `clientTypes=['seller']` |
| `suppliers.getById` | 71   | `clients.getById`                            |
| `suppliers.search`  | 133  | `clients.list` with search                   |
| `suppliers.create`  | 181  | `clients.create` with `isSeller=true`        |
| `suppliers.update`  | 243  | `clients.update`                             |
| `suppliers.delete`  | 325  | `clients.delete`                             |
...
_This report was generated by analyzing 484 commits from December 20, 2025 to January 20, 2026._
_QA pass 1 completed 2026-01-20 to verify completeness._
_Deep QA pass 2 completed 2026-01-20 for thorough analysis._
