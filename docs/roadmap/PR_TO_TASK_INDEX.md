...
- Seed cannabis images tooling exists in `scripts/seed/seeders/seed-cannabis-images.ts`
...
1. DATA-021 completion claim → Map to existing DATA-021 (status update requires verification)
...
- Intake session vendor_id fix already present in `scripts/seed-comprehensive.ts`
...
- Short constraint names in migrations 0020/0021 already present
