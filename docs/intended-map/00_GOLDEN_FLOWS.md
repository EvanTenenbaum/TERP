...
3. Fill intake form: Supplier, Brand, Category, Product/Strain, Quantity, COGS, Payment Terms, Location
...
Complete purchasing cycle from PO creation through goods receipt and supplier payment.
...
- Inventory Manager: PO creation, intake
- Accounting Manager: Bill recording, payment

### Known Gaps

- PO Intake UI not implemented (API-only)
...
| GF-002 | PARTIAL     | PO Intake UI not implemented       |
