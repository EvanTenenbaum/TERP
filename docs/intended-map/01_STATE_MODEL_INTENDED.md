...
| `SENT`      | Sent to supplier     | -          | GF-002:4      |
| `CONFIRMED` | Supplier confirmed   | -          | GF-002:4      |
...
| `SENT`                | `CONFIRMED` | confirm         | Supplier action             | -              | GF-002:4      |
...
| `VENDOR_RETURN_REQUESTED` | Supplier Return  | Going back to supplier       | GF-008:Alternative |
...
| `FULFILLED`        | `VENDOR_RETURN_REQUESTED` | supplier return | -                                   | -                                   | GF-008             |
