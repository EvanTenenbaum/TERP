...
| `GF-002-PROCURE-TO-PAY.md`  | 1.1     | PO creation to supplier payment | Draft       | PO Intake UI not implemented              |
...
| `WS-002-SPEC.md` | Pay Supplier                  | Complete |
...
| `WS-014-SPEC.md` | Supplier Harvest Reminder     | Complete |
...
| `supplier-to-supplier-frontend-unification/requirements.md` | Terminology migration     | Complete    |
