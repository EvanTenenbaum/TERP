...
| GF-002 | PARTIAL     | 60%            | PO Intake UI missing               |
...
| ID        | Type            | Description                    | Impact                        | Remediation         |
| --------- | --------------- | ------------------------------ | ----------------------------- | ------------------- |
| DELTA-004 | IntendedMissing | PO Intake UI (GF-002)          | Cannot receive via UI         | Build intake screen |
...
| ------------------------ | --------------- | --------------------- |
| PO Intake UI             | GF-002          | API exists, no UI     |
...
| Legacy supplier routes | Still active     | Deprecate            |
