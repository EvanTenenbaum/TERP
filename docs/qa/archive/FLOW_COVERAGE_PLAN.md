...
| `CRM.SupplierProfile.Get`        | `clients.getSupplierProfile`         | query    | Purchasing | Supplier data           |
| `CRM.SupplierProfile.Update`     | `clients.updateSupplierProfile`      | mutation | Purchasing | Supplier updates        |
