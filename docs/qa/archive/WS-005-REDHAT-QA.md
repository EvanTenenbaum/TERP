...
| FR-06: Supplier balance audit                      | ✅     | getVendorBalanceBreakdown implemented       |
...
- **Location:** Client Profile, Inventory, Order Detail, Supplier Profile pages
...
| View supplier breakdown   | Shows bills/payments with running balance  | ✅ Implemented |
