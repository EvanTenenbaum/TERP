...
**Problem:** Key procurement steps such as requisition approval, supplier selection, purchase-order generation, intake/inspection, and invoice matching are absent. Modules like Fulfillment, Pick & Pack, Procurement, Returns, and Samples display empty tables or placeholder text.
...
- [ ] **Procurement:**
  ...
  - [ ] Select suppliers and generate purchase orders.
- [ ] **Fulfillment:**
