...
| ID     | Requirement                                                                                                                                     | Priority  |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| INV-01 | Display inventory batches with columns: Supplier Code/Date, Source, Category, Item, Available, Intake (read-only), Ticket, Sub, Notes, Confirm. | Must Have |
...
| INT-02 | Columns: Supplier (autocomplete), Category (dropdown), Item (autocomplete), Qty, COGS, Payment Terms (dropdown), Location (dropdown), Notes. | Must Have   |
...
| CLI-02 | Columns: Date, Supplier Code, Item, Qty, Unit Price, Total, Payment, Note, Paid (X), Invoiced (X), Confirmed (X). | Must Have |
...
| Submit new intake    | Click "Submit Intake"                | `inventoryIntakeService.processIntake` | Required fields, COGS validation, supplier validation |
