...
| ------ | ------------------------------------------ | --------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| A      | Supplier Code / Date                       | Combined field: Date header rows (5/27, 6/13, etc.) + Supplier codes (A3, S7, J75, B17) | A3, S7, J75, B17, dates                                    |
| B      | Source (brand)                             | Supplier/Brand name                                                                     | Snow, Seven, Dr Jones, Berny                               |
...
2. **Supplier code prefix**: Each item row starts with a supplier code (A3, S7, J75, B17)
3. **Color coding**:
...
| B      | #      | Supplier/Batch code   | B17, S10, M15, S7, T5, A4, D14              |
...
| ----------------- | ---------------------------- | ------------------------------- |
| Supplier Code     | lots                         | code                            |
| Source (brand)    | suppliers/clients (isSeller) | name                            |
...
| # (Supplier code) | lots/batches | code          |
| Item              | products     | name          |
...
1. Receive product from supplier on specific date
2. Assign supplier code (A3, S7, etc.)
...
2. Link to supplier/batch codes
