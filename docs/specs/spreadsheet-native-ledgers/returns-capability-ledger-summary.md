...
3. Approval workflow has NO UI surface — 4 procedures are dark (approve, reject, receive, process)
...
| RET-017 | Approve return                 | Mutation       | P0          | Adopt — no UI                             |
| RET-018 | Reject return                  | Mutation       | P0          | Adopt — no UI                             |
| RET-019 | Receive returned items         | Mutation       | P0          | Adopt — no UI                             |
| RET-020 | Process return + issue credit  | Mutation       | P1          | Adopt — no UI                             |
| RET-021 | Cancel return                  | Mutation       | P1          | Adopt — no UI                             |
...
| DISC-RET-004 | Approval workflow (4 procedures) has zero UI surface                                           | High     |
