You are performing a skeptical adversarial review of the April 9, 2026 TERP UI ticket train Foundation tranche only.

Scope:
- Review only `TER-1092` through `TER-1097`
- Use the implementation notes, foundation audit, runtime evidence, and current patch diff to judge whether each ticket is actually complete
...
- Produce exactly one score entry for each ticket `TER-1092`, `TER-1093`, `TER-1094`, `TER-1095`, `TER-1096`, and `TER-1097`
