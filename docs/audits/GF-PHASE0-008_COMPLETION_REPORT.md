...
| INFRA-DB-004 | Complete Suppliers → Clients Migration | MEDIUM   | 24h      | deferred |
...
- Issue #10: Suppliers → clients migration (24h)
...
| GF-002 Procure-to-Pay    | #4, #5, #7, #11  | PO/supplier integrity    |
