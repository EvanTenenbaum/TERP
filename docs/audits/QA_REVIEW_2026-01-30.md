...
| `d3c2a1f` | SCHEMA-015: Alerts supplier join removal  | SHIP    |
...
### SCHEMA-015: Alerts Supplier Join Removal (SHIP)

**Changes Made**:

- Replaced `suppliers` table join with `clients` (isSeller=true)
...
| --------- | ----------------------- | ---------------- |
| suppliers | clients (isSeller=true) | In progress      |
