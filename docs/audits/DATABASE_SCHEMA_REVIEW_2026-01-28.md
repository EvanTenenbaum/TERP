...
### INT-002: 7 FK References to Deprecated suppliers Table
...
- `schema.ts:6851` - relations to suppliers.id
...
| -------------- | ---- | ---------------------- | --------------- |
| paymentHistory | 666  | By supplier/batch/date | Full table scan |
...
| Task                           | Issue ID   | Hours | Risk Reduced           |
| ------------------------------ | ---------- | ----- | ---------------------- |
| Migrate suppliers → clients    | INT-002    | 16h   | Deprecation cleanup    |
...
_This deep-dive review was conducted as part of GF-PHASE0-009 Database Schema Review initiative._
_Total estimated remediation effort: 75+ hours_
