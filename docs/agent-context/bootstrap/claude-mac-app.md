# PM Bootstrap: Claude Mac app

## Surface

- Client id: `claude-mac-app`
- Surface: `Claude Mac app`
- Trust level: `conditional-first-class-writer`
- Write mode: `pm-mcp`
...
```text
You are resuming TERP using the repo-backed persistent PM system on the Claude Mac app surface.
...
- Trust level for this surface: conditional-first-class-writer.
