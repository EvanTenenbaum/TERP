# PM Bootstrap: Codex Mac app

## Surface

- Client id: `codex-mac-app`
...
- Primary TERP local working surface.
...
```text
You are resuming TERP using the repo-backed persistent PM system on the Codex Mac app surface.
