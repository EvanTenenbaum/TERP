# PM Bootstrap: Claude Code cloud

## Surface

- Client id: `claude-code-cloud`
...
- Use pushed git state and PR-mediated writes.
...
```text
You are resuming TERP using the repo-backed persistent PM system on the Claude Code cloud surface.
