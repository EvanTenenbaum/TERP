...
| Returned  | Items returned           | Restock, Return to Supplier    |
...
```json
{
  ...
  "totalAmount": 15000.0,
  "allocations": [
    { "invoiceId": 2891, "amount": 7000.0 },
    { "invoiceId": 2845, "amount": 5500.0 },
    { "invoiceId": 2801, "amount": 2500.0 }
  ],
  "paymentMethod": "ACH",
...
| Return Processed   | O2C → Inventory | Restocks or returns to supplier               |
