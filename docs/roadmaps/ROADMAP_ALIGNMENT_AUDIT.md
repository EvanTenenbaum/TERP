...
- **Purchasing**: Purchase orders, supplier supply, returns processing
...
- Deprecated `suppliers` table - Documented in deprecated-systems.md, supplier router has deprecation warnings
...
| ------------------------ | -------------- | --------------------------------------------- | ------------------------------------------------ | ------ | ------------------------------ |
| `suppliers` router       | 🧟 ZOMBIE      | Deprecated but still used                     | `07-deprecated-systems.md`, supplier router code | Medium | Create DEPR-001 migration task |
...
| ------------------------------- | ---------------------------------------- | ----------------------------------------------- | ---------- |
| New supplier table integrations | `suppliers` table is deprecated          | `.kiro/steering/07-deprecated-systems.md:29-62` | HIGH       |
...
| 4   | Should deprecated supplier router be removed or maintained? | A) Remove Q1 2026 B) Maintain longer                       | MEDIUM - Migration effort   |
...
_This audit was generated without making any code or behavior changes. All findings are based on documented evidence with file paths and line numbers cited._
