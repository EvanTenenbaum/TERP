...
**Duration**: 8-10 hours  
**Agent**: Full Stack Developer  
**Files**: `inventory/`, `batches/`, `products/`, `suppliers/`

| ID    | Task                    | Description                   |
| ----- | ----------------------- | ----------------------------- |
| INV-1 | Supplier management     | Full CRUD for suppliers       |
| INV-2 | Purchase order creation | Create PO to supplier         |
| INV-3 | PO intake               | Receive goods, create batches |
...
| ACCT-2 | AP tracking            | Accounts payable to suppliers  |
