...
| WS-002      | Quick Action: Pay Supplier           | CRITICAL | 12h   | B              |
...
- [ ] Payment receipt and supplier payment quick actions functional
...
| WS-012 | Supplier Harvesting Reminder   | MEDIUM   | 8h    | C              |
...
- [ ] Supplier harvest reminders in calendar
