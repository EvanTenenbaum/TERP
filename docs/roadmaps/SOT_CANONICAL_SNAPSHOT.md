...
| ------------------------ | ------------------------------ | -------------- |
| `suppliers` table        | `clients` with `isSeller=true` | Q2 2026        |
...
_This snapshot represents the best-evidence view of TERP's current state as of 2026-01-20.
All claims are backed by file paths cited in ROADMAP_ALIGNMENT_AUDIT.md._
