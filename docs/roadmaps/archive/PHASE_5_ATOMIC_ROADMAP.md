...
- **11 router files**: accounting, clients, inbox, inventory, orders, purchaseOrders, samples, strains, todoLists, todoTasks, suppliers
...
| Op # | Operation                        | File                             | Est Time | Dependencies |
| ---- | -------------------------------- | -------------------------------- | -------- | ------------ |
| D-01 | Audit React Query usage patterns | client/src/\*_/_.tsx             | 30 min   | None         |
| D-02 | Identify redundant API calls     | client/src/\*_/_.tsx             | 30 min   | D-01         |
