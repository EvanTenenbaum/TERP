...
| ----------------- | ------------------------------------ | ----------------------------------------------------- |
| TER-248 scope     | "cash locations + supplier payables" | strains (4 cols) + referral_settings (5 cols)         |
...
## Wave 3: Suppliers Table Migration (3-4 days, STRICT)
...
| 3         | Suppliers table removal  | 2+1          | 10h      | STRICT      | Sequential ordering |
