...
5. Build processVendorReturn (creates supplier return records)
...
- [ ] Supplier return creates records
...
| **NAV-011** | Add Supplier Supply to Inventory nav | 5m       | navigation.ts      |
...
| Task         | Description                               | Estimate |
| ------------ | ----------------------------------------- | -------- |
| **DEPR-001** | Migrate Deprecated Supplier Router Usages | 8h       |
...
_This execution plan was generated from MASTER_ROADMAP.md v6.5 and INCOMPLETE_FEATURES_TASKS_2026-01-20.md. All task estimates are from source documents. Actual execution times may vary._
