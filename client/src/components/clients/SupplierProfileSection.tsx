 ...
 */
export const SupplierProfileSection = React.memo(
  function SupplierProfileSection({
    ...
    const updateProfileMutation =
      trpc.clients.updateSupplierProfile.useMutation({
        onSuccess: () => {
                ...
                <TableBody>
                  {purchaseOrders.slice(0, 5).map(po => (
                    <TableRow key={po.id}>
                      ...
                      <TableCell>
                        {getPOStatusBadge(po.purchaseOrderStatus)}
                      </TableCell>
          ...
          <DialogContent className="w-full sm:max-w-2xl">
            ...
            <form
              onSubmit={e => {
                ...
                const paymentMethod = formData.get(
                ...
                updateProfileMutation.mutate({
                  ...
                  licenseNumber:
                    (formData.get("licenseNumber") as string) || undefined,
                  taxId: (formData.get("taxId") as string) || undefined,
                  paymentTerms:
                    (formData.get("paymentTerms") as string) || undefined,
                  preferredPaymentMethod: (validPaymentMethods.includes(
                    paymentMethod as PaymentMethod
                  )
                    ? paymentMethod
                    : undefined) as PaymentMethod | undefined,
                  supplierNotes:
                    (formData.get("supplierNotes") as string) || undefined,
                });
              }}
            >
