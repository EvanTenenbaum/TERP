...
export const ordersRolloutRequirements: OrdersRolloutRequirementRecord[] = [
  ...
  },
  {
    ...
    ownerClass: "foundation-shared",
    implementationSource:
      "PowersheetGrid field-state styling contract with CSS editable/locked cell cues",
  ...
  },
  {
    ...
    ownerClass: "foundation-shared",
    implementationSource:
      "PowersheetGrid partial-failure and blocked-field toast messaging",
  ...
  },
  {
    ...
    ownerClass: "foundation-shared",
    implementationSource:
      "KeyboardHintBar integrated into queue and document surfaces with context-specific hints",
  ...
  },
  {
    ...
    ownerClass: "foundation-shared",
    implementationSource:
      "Orders queue, support grids, and document-grid adoption of PowersheetGrid with shared selectionMode, selection summary, release gate contracts, and shared affordance matrix",
  ...
  },
  {
    ...
    ownerClass: "orders-owned",
    implementationSource:
      "Orders queue workflow target badge, multi-row guardrail, and document workflow context bar",
  ...
  },
  {
    ...
    ownerClass: "foundation-shared",
    implementationSource:
      "Per-surface affordance matrix rendered in PowersheetGrid summary with KeyboardHintBar integration",
