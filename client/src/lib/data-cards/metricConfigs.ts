...
export const METRIC_CONFIGS: Record<string, MetricConfig> = {
  ...
  quotes_total: {
    id: 'quotes_total',
    label: 'Total Quotes',
    description: 'All quotes in system',
    icon: FileText,
    color: 'text-blue-600',
    format: 'count',
    category: 'operational',
  ...
  quotes_accepted: {
    id: 'quotes_accepted',
    label: 'Accepted',
    description: 'Quotes accepted by clients',
    icon: CheckCircle2,
    color: 'text-green-600',
    format: 'count',
    category: 'operational',
  ...
  quotes_rejected: {
    id: 'quotes_rejected',
    label: 'Rejected',
    description: 'Quotes rejected by clients',
    icon: XCircle,
    color: 'text-red-600',
    format: 'count',
    category: 'operational',
  ...
  quotes_expired: {
    id: 'quotes_expired',
    label: 'Expired',
    description: 'Quotes past expiration date',
    icon: Clock,
    color: 'text-orange-600',
    format: 'count',
    category: 'operational',
    destination: {
      path: '/quotes',
      getParams: () => ({ status: 'EXPIRED' }),
    },
  },
  
  quotes_total_value: {
    id: 'quotes_total_value',
    label: 'Total Quote Value',
    description: 'Combined value of all quotes',
    icon: DollarSign,
    color: 'text-green-600',
    format: 'currency',
    category: 'financial',
