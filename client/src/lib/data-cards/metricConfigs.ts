...
export const METRIC_CONFIGS: Record<string, MetricConfig> = {
  ...
  vendor_available: {
    ...
    description: "Items available from suppliers",
    icon: Package,
    color: "text-green-600",
    format: "count",
    category: "operational",
  ...
  vendor_reserved: {
    ...
    description: "Items reserved from suppliers",
    icon: TrendingUp,
    color: "text-blue-600",
    format: "count",
    category: "operational",
  ...
  vendor_total: {
    id: "vendor_total",
    label: "Total Items",
    description: "All supplier supply items",
    icon: Package,
    color: "text-blue-600",
    format: "count",
    category: "operational",
  ...
  vendor_by_vendor: {
    id: "vendor_by_vendor",
    label: "Top Supplier",
    description: "Supplier with most items",
    icon: Building,
    color: "text-indigo-600",
    format: "count",
    category: "analytical",
  ...
  vendor_total_value: {
    ...
    label: "Total Value",
    description: "Total value of supplier supply",
    icon: DollarSign,
    color: "text-green-600",
    format: "currency",
    category: "financial",
