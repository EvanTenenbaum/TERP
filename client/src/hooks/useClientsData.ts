...
interface UseClientsDataReturn {
  ...
  /** Get client by ID */
  getClientById: (clientId: number | null | undefined) => ClientBasic | undefined;
 ...
 */
export function useClientsData(options: UseClientsDataOptions = {}): UseClientsDataReturn {
 ...
 */
export function useSuppliersData(options: Omit<UseClientsDataOptions, 'clientTypes'> = {}) {
 ...
 * Convenience wrapper around useClientsData
 */
export function useCustomersData(options: Omit<UseClientsDataOptions, 'clientTypes'> = {}) {
  return useClientsData({
    ...options,
    clientTypes: ['buyer'],
  });
