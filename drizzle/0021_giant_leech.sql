...
ALTER TABLE `client_interest_list_items` ADD CONSTRAINT `client_int_list_items_int_list_id_fk` FOREIGN KEY (`interest_list_id`) REFERENCES `client_interest_lists`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
