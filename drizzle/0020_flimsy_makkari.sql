...
ALTER TABLE `calendar_recurrence_instances` ADD CONSTRAINT `cal_recur_inst_parent_event_fk` FOREIGN KEY (`parent_event_id`) REFERENCES `calendar_events`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
