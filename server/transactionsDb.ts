...
export async function getTransactionsByClient(
  ...
  try {
    ...
    throw new Error(
      `Failed to fetch client transactions: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
...
export async function linkTransactions(
  ...
  try {
    ...
    if (reverseLink) {
      throw new Error(
        "Cannot create circular reference: child transaction is already a parent of parent transaction"
      );
    }
    ...
    throw new Error(
      `Failed to link transactions: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
...
export async function getTransactionLinks(transactionId: number): Promise<{
  ...
  try {
    ...
    throw new Error(
      `Failed to fetch transaction links: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
 ...
 */
export async function getTransactionWithRelationships(
  ...
  try {
    ...
    throw new Error(
      `Failed to fetch transaction relationships: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
...
> {
  ...
  try {
    ...
    throw new Error(
      `Failed to fetch client transaction history: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
...
export async function removeTransactionLink(linkId: number): Promise<boolean> {
  ...
  try {
    ...
    throw new Error(
      `Failed to remove transaction link: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
...
export async function generateTransactionNumber(
  ...
  try {
    ...
    throw new Error(
      `Failed to generate transaction number: ${error instanceof Error ? error.message : "Unknown error"}`
    );
  }
}
