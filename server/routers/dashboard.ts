...
export const dashboardRouter = router({
    ...
    getLayout: protectedProcedure.use(requirePermission("dashboard:read"))
      .query(async ({ ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.getUserWidgetLayout>>> => {
    ...
    saveLayout: protectedProcedure.use(requirePermission("dashboard:read"))
      ...
      .mutation(async ({ input, ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.saveUserWidgetLayout>>> => {
        if (!ctx.user) throw new Error("Unauthorized");
    ...
    resetLayout: protectedProcedure.use(requirePermission("dashboard:read"))
      .mutation(async ({ ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.resetUserWidgetLayout>>> => {
        if (!ctx.user) throw new Error("Unauthorized");
    ...
    getRoleDefault: protectedProcedure.use(requirePermission("dashboard:read"))
      ...
      .query(async ({ input, ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.getRoleDefaultLayout>>> => {
    ...
    saveRoleDefault: protectedProcedure.use(requirePermission("dashboard:read"))
      ...
      .mutation(async ({ input, ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.saveRoleDefaultLayout>>> => {
        if (!ctx.user || ctx.user.role !== "admin") {
          throw new Error("Forbidden: Admin only");
        }
    ...
    getKpiConfig: protectedProcedure.use(requirePermission("dashboard:read"))
      .query(async ({ ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.getRoleKpiConfig>>> => {
        if (!ctx.user) throw new Error("Unauthorized");
    ...
    saveKpiConfig: protectedProcedure.use(requirePermission("dashboard:read"))
      ...
      .mutation(async ({ input, ctx }): Promise<Awaited<ReturnType<typeof dashboardDb.saveRoleKpiConfig>>> => {
        if (!ctx.user || ctx.user.role !== "admin") {
          throw new Error("Forbidden: Admin only");
        }
