...
export const vipPortalAdminRouter = router({
  ...
  clients: router({
    ...
    impersonate: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        return await vipPortalAdminService.createImpersonationSession(
          input.clientId,
          ctx.user?.id
        );
      }),
  ...
  config: router({
    get: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await vipPortalAdminService.getVipPortalConfiguration(
          input.clientId
        );
      }),
    ...
    applyTemplate: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await vipPortalAdminService.applyConfigurationTemplate(
          input.clientId,
          input.template
        );
      }),
    ...
    copyConfig: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await vipPortalAdminService.copyConfiguration(
  ...
  tier: router({
    ...
    updateConfig: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const tiersWithId = input.tiers.filter(
          (t): t is typeof t & { id: number } => typeof t.id === "number"
        );
        return await vipPortalAdminService.updateVipTierConfiguration(
          tiersWithId
        );
      }),
  }),
  ...
  leaderboard: router({
    getConfig: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await vipPortalAdminService.getLeaderboardConfiguration(
          input.clientId
        );
      }),
    ...
    updateConfig: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await vipPortalAdminService.updateLeaderboardConfiguration(
          input
        );
      }),
  }),
  ...
  liveCatalog: router({
    ...
    getConfiguration: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await vipPortalAdminService.getLiveCatalogConfiguration(
          input.clientId
        );
      }),
    ...
    interestLists: router({
      ...
      addToNewOrder: protectedProcedure
        .use(requirePermission("vip_portal:manage"))
        .input(
          z.object({
            listId: z.number(),
        ...
        .mutation(
          async ({
            ...
            const selectedItems =
              list.items?.filter((item: { id: number }) =>
      ...
      addToDraftOrder: protectedProcedure
        .use(requirePermission("vip_portal:manage"))
        .input(
          z.object({
            listId: z.number(),
        ...
        .mutation(
          async ({
            input,
          }): Promise<{ itemsAdded: number; orderNumber: string }> => {
            // Get interest list with items
            const list = await vipPortalAdminService.getInterestListById(
              input.listId
            );
            ...
            const { addItemsToOrder, getOrderById } =
              await import("../services/orderService");
    ...
    draftInterests: router({
      getByClient: protectedProcedure
        ...
        .query(async ({ input }) => {
          return await vipPortalAdminService.getDraftInterestsByClient(
            input.clientId
          );
        }),
    }),
    ...
    priceAlerts: router({
      list: protectedProcedure
        ...
        .query(async ({ input }) => {
          return await vipPortalAdminService.getClientPriceAlerts(
            input.clientId
          );
        }),
      ...
      deactivate: protectedProcedure
        ...
        .mutation(async ({ input }) => {
          return await vipPortalAdminService.deactivateClientPriceAlert(
            input.alertId
          );
        }),
    }),
  ...
  audit: router({
    ...
    createImpersonationSession: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const adminUserId = getAuthenticatedUserId(ctx);
    ...
    revokeSession: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const revokedByUserId = getAuthenticatedUserId(ctx);
  ...
  debtAging: router({
    ...
    getAgingDebt: protectedProcedure
      .use(requirePermission("vip_portal:manage"))
      .query(async () => {
        const { getVipClientsWithAgingDebt } =
          await import("../services/vipDebtAgingService");
    ...
    sendNotifications: protectedProcedure
      .use(requirePermission("vip_portal:manage"))
      .mutation(async () => {
        const { sendDebtAgingNotifications } =
          await import("../services/vipDebtAgingService");
    ...
    getClientSummary: protectedProcedure
      ...
      .query(async ({ input }) => {
        const { getClientDebtAgingSummary } =
          await import("../services/vipDebtAgingService");
