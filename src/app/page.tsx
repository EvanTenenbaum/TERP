...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold mb-2">Welcome to ERPv3</h1>
        <p className="text-[var(--c-mid)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {modules.map((module) => (
          <Link key={module.href} href={module.href}>
            <Card className="h-full hover:border-[var(--c-brand)] transition-colors">
              <div className="flex items-start gap-4">
                <div className="text-[var(--c-brand)]">{module.icon}</div>
                <div className="flex-1">
                  <h3 className="font-semibold mb-1">{module.title}</h3>
                  <p className="text-sm text-[var(--c-mid)]">{module.description}</p>
                </div>
              </div>
            </Card>
          </Link>
