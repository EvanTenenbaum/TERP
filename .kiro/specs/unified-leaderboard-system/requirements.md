...
### Requirement 21: Data Calculation Engine
...
### Requirement 22: Performance and Caching
...
### Dashboard Widget - Top Clients

```
┌─────────────────────────────────────────────────────────────────┐
│ 🏆 Top Clients                    [Master Score ▼] [View All →]│
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  🥇 Acme Cannabis Co          94.2  ████████████████░░  ↑ +3   │
│  🥈 Green Leaf Distro         91.8  ███████████████░░░  ↑ +1   │
│  🥉 Pacific Farms LLC         88.4  ██████████████░░░░  ─  0   │
│     Valley Distribution       85.1  █████████████░░░░░  ↓ -2   │
│     Mountain High Supply      82.7  ████████████░░░░░░  ↑ +5   │
│                                                                 │
│  ─────────────────────────────────────────────────────────────  │
│  📊 147 total clients │ Updated 5 min ago                       │
└─────────────────────────────────────────────────────────────────┘
```

### Dashboard Widget - Needs Attention (Alternative View)

```
┌─────────────────────────────────────────────────────────────────┐
│ ⚠️ Needs Attention                [Payment Rate ▼] [View All →]│
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ⚠ Sunset Collective          45.2%  ██████░░░░░░░░░░  ↓ -12%  │
│  ⚠ Harbor Cannabis            52.1%  ███████░░░░░░░░░  ↓ -8%   │
│  ⚠ Coastal Greens             58.4%  ████████░░░░░░░░  ↓ -5%   │
│  ⚠ Metro Dispensary           61.2%  █████████░░░░░░░  ─  0%   │
│  ⚠ Urban Leaf Co              63.8%  █████████░░░░░░░  ↑ +2%   │
│                                                                 │
│  ─────────────────────────────────────────────────────────────  │
│  📊 12 clients below 70% threshold │ Updated 5 min ago          │
└─────────────────────────────────────────────────────────────────┘
```

### Client Profile - Leaderboard Standing Card

```
┌─────────────────────────────────────────────────────────────────┐
│ 🏆 Leaderboard Standing                              [Expand ↓]│
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ┌───────────────────┐  ┌─────────────────────────────────────┐│
│  │                   │  │ RANK BREAKDOWN                      ││
│  │   🥈 #5           │  │                                     ││
│  │   out of 147      │  │ Financial    #3   ████████████░░░░  ││
│  │                   │  │ Engagement   #8   █████████░░░░░░░  ││
│  │   Top 3%          │  │ Reliability  #12  ███████░░░░░░░░░  ││
│  │   ↑ +2 this month │  │ Growth       #5   ██████████░░░░░░  ││
│  │                   │  │                                     ││
│  └───────────────────┘  └─────────────────────────────────────┘│
│                                                                 │
│  ┌─────────────────────────────────────────────────────────────┐│
│  │ RANK HISTORY (6 months)                                     ││
│  │                                                             ││
│  │  #1 ─                                                       ││
│  │  #5 ─        ╭──╮     ╭─────────────●                       ││
│  │ #10 ─   ╭────╯  ╰─────╯                                     ││
...
│  │ GAP TO NEXT RANK                                            ││
│  │                                                             ││
│  │ You're $12,450 in YTD revenue away from #4 (Valley Distro)  ││
│  │ Improve payment speed by 2 days to move up in Reliability   ││
│  └─────────────────────────────────────────────────────────────┘│
│                                                                 │
│  QUICK ACTIONS                                                  │
│  [📧 Send Follow-up] [📅 Schedule Call] [💳 Review Credit]     │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
