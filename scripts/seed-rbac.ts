 ...
 * - 255 granular permissions
 * - Role-to-permission mappings
 * 
 * Run with: pnpm tsx scripts/seed-rbac.ts
 */
...
const ownerExecutivePermissions = [
  "dashboard:access",
  "dashboard:view_kpis",
  "dashboard:customize",
  "analytics:access",
...
const buyerProcurementPermissions = [
  "dashboard:access",
  "dashboard:view_kpis",
  "analytics:access",
  "analytics:view_reports",
...
const warehouseStaffPermissions = [
  "dashboard:access",
  "dashboard:view_kpis",
  "clients:access",
  "clients:read",
...
const readOnlyAuditorPermissions = [
  "dashboard:access",
  "dashboard:view_kpis",
  "analytics:access",
  "analytics:view_reports",
...
async function seedRBAC() {
  ...
  try {
    ...
    const insertedRoles = await db.insert(roles).values(ROLES).$returningId();
