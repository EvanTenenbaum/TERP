 ...
 *
 * Used by `scripts/mega-qa/index.ts` to enforce a minimal coverage gate.
 */
...
const REQUIRED_TAGS: CoverageTag[] = [
  ...
  { id: "route:/dashboard", category: "route", description: "Dashboard route loads", required: true },
  ...
  { id: "route:/inventory", category: "route", description: "Inventory route loads", required: true },
  ...
  { id: "api:orders.list", category: "api", description: "Orders list procedure works", required: true },
  { id: "api:clients.list", category: "api", description: "Clients list procedure works", required: true },
  { id: "api:batches.list", category: "api", description: "Batches list procedure works", required: true },
