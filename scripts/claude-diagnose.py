#!/usr/bin/env python3
"""
Claude API script to diagnose GitHub Actions test failures and generate fixes.
"""
...
message = client.messages.create(
    ...
    messages=[
        {
            "role": "user",
            "content": f"""You are a DevOps expert analyzing GitHub Actions test failures. 
...
# Print the response
print("=" * 80)
print("CLAUDE API DIAGNOSIS RESULTS")
print("=" * 80)
print(message.content[0].text)
print("=" * 80)

# Save the response to a file
with open('/home/ubuntu/TERP/scripts/claude-diagnosis-result.md', 'w') as f:
    f.write("# Claude API Diagnosis Results\n\n")
    f.write(message.content[0].text)

print("\nDiagnosis saved to /home/ubuntu/TERP/scripts/claude-diagnosis-result.md")
